...
<section class="relative flex justify-center">
    <div class="container w-[90%] flex flex-col-reverse lg:flex-row items-center lg:gap-12 mld:gap-2 gap-8 mt-14 mb-8 lg:my-20">
        <div class="flex flex-1 flex-col items-center lg:items-start">
            <h2 class="text-green-800 dark:text-gray-100 text-3xl md:text-4xl lg:text-6xl text-center lg:text-left mb-6">Travel 25 <br> provinces/ citys in
                Cambodia!
            </h2>
            <p class="md:text-lg text-base text-green-500 dark:text-gray-400 text-center lg:text-left mb-6">
                We gather all important informations regarding each places.
            </p>
        </div>
...
<section>
    <div class="container mx-auto flex flex-col justify-start w-[90%] mb-10">
        ...
        flex-col gap-4 lg:p-0 p-5">
            ...
            <div class="lg:w-1/4 w-full h-12">
                <select id="type" class="bg-green-300 dark:bg-gray-400 rounded-2xl w-full h-12 px-4 text-black border-none  focus:outline-none focus:ring-2 focus:ring-green-600 dark:focus:ring-gray-600">
                ...
                <div class="px-8 pt-5 flex-1">
                  <div class="flex flex-row justify-between">
                      <div class="flex flex-col">
                          <h5 class="text-lg text-green-700 md:text-2xl font-bold mt-3">Angkor Wat</h5>
                          <h6>Siem Reap</h6>
                      </div>
