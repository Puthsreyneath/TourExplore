...
<section>
<form action="/booking/store" method="POST" id="form1">
    <section id="fyi_section">
            ...
            <div class="px-80">
                @csrf
                    ...
                    <div class="">
                            ...
                            <input class="ml-10  mb-3 w-48" type="text" name="fname" ></div>

                            <div ><label for="lname">Last Name:</label>
                            <input class=" ml-10 mb-3 w-48" type="text" name="lname" ></div>
                            

                            <div class=""><label for="email">Email:</label>
                            <input class=" ml-20 mb-3 w-48" type="email" name="email" required></div>

                            <div><label for="tel">Phone Number:</label>
                            <input class="ml-13 mb-3 w-48" type="text" name="tel" required></div>
                            
                            <div>
                            <label for="address">Address:</label>
                            <select name="address" id="address" class=" w-48 ml-14 mb-3">
                                @foreach($locations as $h)
                                    <option value="{{$h->province}}">{{$h->province}}</option>
                                @endforeach  
                            </select>
                            </div>
                    </div>
            </div>                
            <div><a href="#hotel_section"><button class="bg-green-300 px-5 py-3 buttom-0 left-0" form="empty">next</button></a></div>
        </div>
    </section>
    <section class=" bg-green-100 m-10" id = "hotel_section">
        <div class="border border-green-400 p-10">
            <div>
                <h3 class="font-bold text-red-500 pb-5">Hotel</h3>
            </div>
            <div >  
                    <h3>Select one hotel</h3>
                        <div class = "flex items-center shadow-lg pt-5">
                        <div class="pl-5"><input type="radio" id="1" name="ht_choice" ></div>
                        <div class ="ml-20">
                            <label for="1"> 
                            ...
                            <div class = "flex items-center shadow-lg pt-5">
                                <div class="pl-5"><input type="radio" id="2" name="ht_choice" ></div>
                                <div class ="ml-20">
                                <label for="2"> 
                                    <div class="flex items-center justify-between ">
                                        <div class="flex items-center">
                            ...
                            <div class = "flex items-center shadow-lg pt-5">
                                <div class="pl-5"><input type="radio" id="3" name="ht_choice" ></div>
                                <div class ="ml-20">
                                <label for="3"> 
                                    <div class="flex items-center justify-between ">
                                        <div class="flex items-center">
                            ...
                            <div class = "flex items-center shadow-lg pt-5">
                                <div class="pl-5"><input type="radio" id="4" name="ht_choice" ></div>
                                <div class ="ml-20">
                                <label for="4"> 
                                    <div class="flex items-center justify-between ">
                                        <div class="flex items-center">
                            ...
                            <div class = "flex items-center shadow-lg pt-5">
                                <div class="pl-5"><input type="radio" id="5" name="ht_choice" ></div>
                                <div class ="ml-20">
                                <label for="5"> 
                                    <div class="flex items-center justify-between ">
                                        <div class="flex items-center">
            ...
            <div><a href="#transport_sec"><button class="bg-green-300 mt-5 px-5 py-3 buttom-0 left-0"form="empty" >next</button></a></div>
        </div>
        
    </section>

    <section id ="transport_sec" class="border border-green-400 m-10">
    <div class="flex justify-between mb-10 p-10"> 
            ...
            <div><a href="http://127.0.0.1:8000/transport"><button class="bg-green-300 ml-10 mb-10 px-5 py-3 buttom-0 left-0" form="empty">Get Transportation</button></a></div>
    </section>
    <section id = "moreInfo_section"class="p-10 bg-green-100">
    ...
    <div class="m-10" ><input class=" bg-green-400 p-3 c" type="submit" name="register" value="COMFIRM BOOKING" form="form1"></div></form>
</section>
